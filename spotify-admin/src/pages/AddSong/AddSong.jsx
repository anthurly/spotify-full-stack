...
const AddSong = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      var khong_dau = removeDiacritics(name);
      formData.append("khong_dau", khong_dau);
  ...
  return loading ? (
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
      ...
      <div className="flex flex-col gap-2.5">
        <p>Singer name</p>
        <input className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[max(40vw,250px)]' onChange={(e) => setActor(e.target.value)} value={actor} type="text" placeholder='Type here' required />
      </div>
      <div className="flex flex-col gap-2.5">
